...
export default function Aside () {
  ...
  const {
    ...
    return (
      <>
        {!showForm ? <aside className='bg-[#FFF0DE] pt-6 md:w-[30%] w-full h-full md:flex flex-col relative overflow-y-hidden '>
            ...
            <div className='font-bold text-[#34333A] px-3 pb-4 mt-10 h-[60%] overflow-y-scroll'>
        ...
        : 
          <form className="md:w-[30%] h-full w-full px-4 pt-6 pb-8 space-y-16 flex flex-col ">
